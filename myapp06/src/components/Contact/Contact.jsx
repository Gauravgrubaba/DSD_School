          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-lg border-2 border-black">
            ...
            <div className="space-y-4">
              <div className="flex items-center text-gray-700">
                ...
                <span className="ml-4 font-semibold">Greenwood International School, City, ZIP Code</span>
              </div>
              ...
              <div className="flex items-center text-gray-700">
                ...
                <span className="ml-4 font-semibold">+44 123 456 7890</span>
              </div>
              ...
              <div className="flex items-center text-gray-700">
                ...
                <span className="ml-4 font-semibold">info@greenwood.edu</span>
              </div>
            </div>
          </div>
